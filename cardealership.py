...
class CarDealership:
    ...
    def adding_cars(self,brand_name,car_model,year_of_production):
        ...
        self.cursor.execute('INSERT INTO cars(brand_name,car_model,year_of_production) VALUES(?,?,?)', (brand_name,car_model,year_of_production))
    ...
    def list_brands(self):
        self.cursor.execute('SELECT brand_name FROM brands')
    ...
    def add_maintenance(self, car_id, maintenance_date, cost):
        ...
        if car_exists:
            self.cursor.execute('INSERT INTO maintenance (maintenance_date, cost, car_id) VALUES (?, ?, ?)', (maintenance_date, cost, car_id))
            self.connection.commit()
...
class CarDealershipUI:
    ...
    def add_car(self):
        ...
        self.dealership.adding_cars(brand_name, car_model, year_of_production)
...
def main():
    ...
    app = CarDealershipUI(dealership)
    app.run()
